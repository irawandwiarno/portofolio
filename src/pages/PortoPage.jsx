    ...
    <div className="lg:flex lg:justify-between lg:gap-4">
        ...
        <div className="text-white lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-sm leading-normal text-slate-400 sm:text-lg">
              I build responsive, seamless, and accessible digital experiences
          ...
          >
            <li className="mr-5 shrink-0 text-xs">
              <a
                ...
                href="https://github.com/irawandwiarno"
                target="_blank"
            ...
            <li className="mr-5 shrink-0 text-xs">
              <a
                className="block hover:text-slate-200"
                href="https://www.linkedin.com/in/irawan-dwiarno-p"
                target="_blank"
                rel="noreferrer noopener"
            ...
            <li className="mr-5 shrink-0 text-xs">
              <a
                className="block hover:text-slate-200"
                href="https://www.instagram.com/awan__n/"
                target="_blank"
                rel="noreferrer noopener"
      ...
      <main className="pt-24 lg:w-[52%] lg:py-24">
        ...
        >
          ...
          <div>
            <p className="mb-4 text-slate-400">
              I'm a developer passionate about creating accessible and visually
              precise user interfaces. I like to combine thoughtful design with
              solid development, building experiences that are not only
              beautiful to look at, but also carefully crafted for performance
              and ease of use.
            </p>
            <p className="mb-4 text-slate-400">
              I'm a developer passionate about creating accessible and visually
        ...
        >
          ...
          <ol className="">
            <ExperienceItem item={items[0]}></ExperienceItem>
            <ExperienceItem item={items[0]}></ExperienceItem>
          </ol>
        </section>
      </main>
